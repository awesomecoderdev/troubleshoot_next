...
import { discord, github, twitter, navigations, facebook } from "@/lib/const";
...
function SocialLink({
	...
	return (
		<Link href={href} target="_blank" className="group">
			...
			<Icon
				className={cn(
					"h-5 w-5 fill-zinc-700 dark:fill-slate-300 transition group-hover:fill-zinc-900 dark:group-hover:fill-white",
					className
				)}
			/>
		</Link>
