		...
		<Fragment>
			{useHydration(
				<Fragment>
					{accepted && (
						<Fragment>
							<section className="fixed max-w-lg p-5 mx-auto bg-white border border-gray-200 dark:bg-gray-800 left-12 bottom-16 dark:border-gray-700 rounded-2xl">
								...
								<p className="mt-4 text-sm text-gray-600 dark:text-gray-300">
									...
									Any unsatiable assistance compliment
									occasional too reasonably advantages.
									<br />{" "}
									<a
										href="#"
