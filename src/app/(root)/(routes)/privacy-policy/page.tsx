			...
			<div className="relative w-full py-10 xl:pt-20">
				...
				<div className="relative py-2 space-y-10">
					<p className="lead text-balance">
						This privacy notice for Troubleshoot Ltd ("Company,"
						...
						as when you: Questions or concerns? Reading this privacy
					...
					<p className="lead text-balance">
						...
						interact with Troubleshoot Ltd and the Services, the
					...
					<p className="lead text-balance">
						...
						we have a valid legal reason to do so. Click here to
						learn more
					</p>
					...
					<p className="lead text-balance">
						...
						our data subject request form available here:
						<Link
							href="/contact"
							target="_blank"
							rel="noopener noreferrer"
						>
							https://troubleshoot.com.bd/contact
						</Link>
					...
					<p className="lead text-balance">
						<strong>
							Want to learn more about what Troubleshoot Ltd does
				...
				<div className="relative py-2 space-y-10">
					...
					<p className="lead text-balance">
						...
						<a
							...
							rel="noopener noreferrer"
						>
							https://sslcommerz.com/privacy-policy/
						</a>{" "}
						and{" "}
						<a
							href="https://www.bkash.com/page/privacy-policy."
							target="_blank"
							rel="noopener noreferrer"
						>
							https://www.bkash.com/page/privacy-policy.
						</a>
					</p>
					<p className="lead text-balance">
					...
					<p className="lead text-balance">
						...
						<Link
							...
							rel="noopener noreferrer"
						>
							https://troubleshoot.com.bd/cookie-policy.
						</Link>
					</p>
					<p className="lead text-balance">
